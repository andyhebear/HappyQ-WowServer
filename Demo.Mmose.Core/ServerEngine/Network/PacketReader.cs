...
namespace Demo.Mmose.Core.Network
{
    ...
    public class PacketReader
    {
            ...
            try
            {
                using ( StreamWriter streamWriter = new StreamWriter( "Unknown_Packets.log", true ) )
                {
                    ...
                    using ( MemoryStream memoryStream = new MemoryStream( byteBuffer ) )
                        Utility.FormatBuffer( streamWriter, memoryStream, this.GetPacketLength() );
        ...
        public long ReadLong64()
        {
            ...
            return m_Data[m_Index++] | ( m_Data[m_Index++] << 8 ) | ( m_Data[m_Index++] << 16 ) | ( m_Data[m_Index++] << 24 ) | ( m_Data[m_Index++] << 32 ) | ( m_Data[m_Index++] << 40 ) | ( m_Data[m_Index++] << 48 ) | ( m_Data[m_Index++] << 56 );
        }
        ...
        public ulong ReadULong64 ()
        {
            ...
            return (ulong)( m_Data[m_Index++] | ( m_Data[m_Index++] << 8 ) | ( m_Data[m_Index++] << 16 ) | ( m_Data[m_Index++] << 24 ) | ( m_Data[m_Index++] << 32 ) | ( m_Data[m_Index++] << 40 ) | ( m_Data[m_Index++] << 48 ) | ( m_Data[m_Index++] << 56 ) );
        }
