...
namespace Demo.Mmose.Core.World.Zone
{
    ...
    /// </summary>
    public partial class Zone_ListenerExtendData : Component
    {
        #region zh-CHS 共有常量 | en Public Constants
        /// <summary>
        /// 
        /// </summary>
        public readonly static ComponentId COMPONENT_ID = "Zone_ListenerExtendData";
        #endregion
    ...
    /// ZoneCluster Server 客户端连接过来存储的数据
    /// </summary>
    public partial class Zone_ConnecterExtendData : Component
    {
        #region zh-CHS 共有常量 | en Public Constants
        /// <summary>
        /// 
        /// </summary>
        public readonly static ComponentId COMPONENT_ID = "Zone_ConnecterExtendData";
        #endregion
