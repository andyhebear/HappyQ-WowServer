...
namespace Demo.Stock.LHP
{
    public partial class DocumentForm : Form
    {
        ...
        DocumentFormSub1 m_DocumentFormSub1 = null;
        ...
        {
            m_DocumentFormSub1 = new DocumentFormSub1();
            m_DocumentFormSub1.Dock = DockStyle.Fill;
            this.SplitContainer.Panel2.Controls.Add( m_DocumentFormSub1 );

            m_CurrentDocumen = m_DocumentFormSub1;
        ...
        private string VolumeString( float stockVolume )
        {
            float newStockVolume = stockVolume * 100;

            CultureInfo ci = new CultureInfo( "en-us" );

            string strStockVolume = newStockVolume.ToString( "C", ci );

            return strStockVolume.Remove( strStockVolume.Length - 3, 3 );
        }
