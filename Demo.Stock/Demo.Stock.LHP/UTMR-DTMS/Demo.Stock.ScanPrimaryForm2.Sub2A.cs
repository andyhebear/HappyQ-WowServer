...
{
    public partial class ScanPrimary2ControlSub2A : UserControl
    {
        ScanPrimary2ControlSub2ASub1 m_ScanControlSub2A = null;
        ScanPrimary2ControlSub2ASub2 m_ScanControlSub2B = null;
        ScanPrimary2ControlSub2ASub3 m_ScanControlSub2C = null;

        public ScanPrimary2ControlSub2A()
        {
            InitializeComponent();
            Initialize();
        }
