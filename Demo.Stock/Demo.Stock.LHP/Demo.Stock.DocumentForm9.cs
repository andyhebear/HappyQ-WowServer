...
{
    public partial class DocumentForm9 : Form
    {
        ...
        DocumentForm9Sub1 m_DocumentFormSub9 = null;

        public DocumentForm9()
        {
            InitializeComponent();
            Initialize();
        }
        ...
        {
            m_DocumentFormSub9 = new DocumentForm9Sub1();
            m_DocumentFormSub9.Dock = DockStyle.Fill;
            this.SplitContainer.Panel2.Controls.Add( m_DocumentFormSub9 );

            m_CurrentDocumen = m_DocumentFormSub9;
        ...
        public void InitSRReport( SRReport[] srReportArray )
        {
            ...
            if ( this.m_CurrentDocumen != null && m_DocumentFormSub9 != this.m_CurrentDocumen )
                this.m_CurrentDocumen.Visible = false;

            m_DocumentFormSub9.Visible = true;
            this.m_CurrentDocumen = m_DocumentFormSub9;
