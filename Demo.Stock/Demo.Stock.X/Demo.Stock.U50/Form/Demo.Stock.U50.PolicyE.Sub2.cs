...
{
    public partial class PolicyEControlSub2 : UserControl
    {
        public PolicyEControlSub2()
        {
            InitializeComponent();
        }
        ...
        private void ConfigEControlSub2_Load( object sender, EventArgs e )
        {
        ...
        {
            if ( this.RadioButtonSmall.Checked == true )
            {
        ...
        {
            if ( this.RadioButtonBigAndSmall.Checked == true )
            {
