...
{
    public class SpellRangeEntry : ILoad<SpellRangeEntry>
    {
        public uint m_SpellRangeID;                    // 0
        public uint ID
        {
            get { return m_SpellRangeID; }
        }
        ...
        {
            this.m_SpellRangeID = dbcRecord.GetUInt( 0 );
            ...
            //LOGs.WriteLine( LogMessageType.MSG_INFO, "{0}, {1}", m_SpellRangeID, m_Unknown23 );

            return true;
        }
    }

    //internal struct SpellRange
    //{
    //    public uint ID;
    ...
    //    public SpellRange Load()
    //    {
    //        SpellRange spellRange = new SpellRange();

    //        spellRange.ID = 0;
    //        spellRange.minRange = 0;
    //        spellRange.maxRange = 0;
    //        spellRange.unks = new uint[35];
