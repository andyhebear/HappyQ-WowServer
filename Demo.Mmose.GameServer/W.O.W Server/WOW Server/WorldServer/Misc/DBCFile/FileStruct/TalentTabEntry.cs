...
{
    public class TalentTabEntry : ILoad<TalentTabEntry>
    {
        public uint m_TalentTabID;                    // 0
        public uint ID
        {
            get { return m_TalentTabID; }
        }
        ...
        {
            this.m_TalentTabID = dbcRecord.GetUInt( 0 );
            ...
            //LOGs.WriteLine( LogMessageType.MSG_INFO, "{0}", m_TalentTabID );
