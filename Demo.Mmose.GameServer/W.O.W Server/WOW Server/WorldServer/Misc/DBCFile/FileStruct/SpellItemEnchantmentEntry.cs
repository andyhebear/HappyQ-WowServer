...
{
    public class SpellItemEnchantmentEntry : ILoad<SpellItemEnchantmentEntry>
    {
        public uint m_SpellItemEnchantmentID;                    // 0
        public uint ID
        {
            get { return m_SpellItemEnchantmentID; }
        }
        ...
        {
            this.m_SpellItemEnchantmentID = dbcRecord.GetUInt( 0 );
            ...
            //LOGs.WriteLine( LogMessageType.MSG_INFO, "{0}, {1}", m_SpellItemEnchantmentID, m_Unknown23 );
