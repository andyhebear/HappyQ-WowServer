...
namespace Demo.Wow.WorldServer.Network
{
    ...
    enum WordOpCode : ushort
    {
        ...
        SMSG_CHARACTER_LOGIN_FAILED = 65,                      //(0x041)  // kick client to character select screen and show "World server is down".
        ...
        SMSG_PET_CAST_FAILED = 312,                            //(0x138) // Your pet is in combat
        ...
        CMSG_DISMOUNT = 885,                                   //(0x375)
        SMSG_ARENA_NO_TEAM = 886,	                           //(0x376)
        MSG_INSPECT_ARENA_STATS = 887,	                       //(0x377)
        SMSG_SPIRIT_HEALER_POS = 888,	                       //(0x378)
        CMSG_CANCEL_TEMPORARY_ENCHANTMENT = 889,               //(0x379)
        SMSG_MOVE_SET_FLY_SPEED = 894,	                       //(0x37E)
        CMSG_MOVE_SET_FLY_SPEED_ACK = 895,	                   //(0x37F)
        SMSG_MOVE_SET_FLY_BACK_SPEED = 896,	                   //(0x380)
        SMSG_FORCE_MOVE_SET_FLY_SPEED = 897,	               //(0x381)
        CMSG_FORCE_MOVE_SET_FLY_SPEED_ACK = 898,	           //(0x382)
        ...
        SMSG_REALM_SPLIT_STATE_RESPONSE = 907,	               //(0x38B)
        CMSG_REALM_SPLIT_STATE_REQUEST = 908,	               //(0x38C)
        CMSG_GROUP_PROMOTE = 910,	                           //(0x38E)
        SMSG_TICKCOUNT_QUERY = 912,	                           //(0x390)
        CMSG_TICKCOUNT_QUERY_RESPONSE = 913,	               //(0x391)
        SMSG_SET_COMBO_POINTS = 925,                           //(0x39D)
        SMSG_PET_LEARNT_SPELL = 932,	                       //(0x3A4)
        SMSG_TARGET_CAST_RESULT = 934,                         //(0x3A6)
        SMSG_READY_CHECK_RESPONSE = 942,                       //(0x3AE)
        CMSG_VOICE_STATUS_UPDATE = 943,                        //(0x3AF)
        CMSG_ENABLE_MICROPHONE = 943,                          //(0x03AF)
        SMSG_DISABLE_MICROPHONE = 944,                         //(0x03B0) // manual added its a result for CMSG_ENABLE_MICROPHONE
        CMSG_REPORT_SPAM = 953,	                               //(0x3B9)
        SMSG_REPORT_SPAM_RESPONSE = 954,	                   //(0x3BA)
        SMSG_ACTIVATE_SPAM_REPORTING = 955,	                   //(0x3BB)
        SMSG_DISCONNECT_CLIENT = 963,                          //(0x03C3)
        CMSG_COMPLAIN_CHAT = 965,                              //(0x03C5)
        SMSG_VOICE_SYSTEM_STATUS = 967,                        //(0x03C7)
        CMSG_CHANNEL_SILENT_VOICE = 970,                       //(0x03CA)
        CMSG_CHANNEL_SILENT_ALL = 971,                         //(0x03CB)
        CMSG_CHANNEL_UNSILENT_ALL = 973,                       //(0x03CD)
        CMSG_CHANNEL_GET_ROSTER_INFO = 976,                    //(0x03D0)
        CMSG_VOICE_CHAT_QUERY = 977,                           //(0x03D1)
        CMSG_CHANNEL_NUM_MEMBERS_QUERY = 978,                  //(0x03D2)
        SMSG_CHANNEL_NUM_MEMBERS_QUERY_RESPONSE = 979,         //(0x03D3)
        ...
        SMSG_PLAYER_JOINED_CHANNEL = 997,                      //(0x03E5)
        SMSG_PLAYER_LEFT_CHANNEL = 998,                        //(0x03E6)
        SMSG_PLAYER_JOINED_CUSTOM_CHANNEL = 999,               //(0x03E7)
        NUM_MSG_TYPES = 1000,                                  //(0x03E8)
    }
}
