...
class CkRss  : public CkObject
{
	...
	// LOADRSSSTRING_END
	// MGETATTR_BEGIN
	bool MGetAttr(const char *tag, int idx, const char *attrName, CkString &outStr);
	const char *mGetAttr(const char *tag, int idx, const char *attrName);
	// MGETATTR_END
	// MGETSTRING_BEGIN
	bool MGetString(const char *tag, int idx, CkString &outStr);
	const char *mGetString(const char *tag, int idx);
	// MGETSTRING_END
	// MSETATTR_BEGIN
