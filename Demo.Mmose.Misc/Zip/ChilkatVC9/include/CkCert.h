...
class CkCert : public CkObject 
{
	...
	//const char *exportPKCS8PEM(void);
	//const char *exportPrivateKeyPEM(void);
	...
	//bool CreateSelfSignedCert(const char *commonName, const char *email,
	    //const char *companyName,const char *orgUnit,const char *city,const char *state,
	    //const char *country);
	//bool CreateSelfSignedCertDn(const char *distinguishedName);
