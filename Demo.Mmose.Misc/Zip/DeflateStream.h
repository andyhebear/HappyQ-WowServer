...
namespace Demo
{
	namespace Mmose
	{
		namespace Zip
		{
			public ref class DeflateStream : public System::IO::Stream
			{
			...
			public:
				DeflateStream(System::IO::Stream^ streamData,  System::IO::Compression::CompressionMode compressionMode );
				DeflateStream(System::IO::Stream^ streamData,  System::IO::Compression::CompressionMode compressionMode, System::Boolean leaveOpen );
				~DeflateStream(void);
				!DeflateStream(void);
				#pragma endregion
