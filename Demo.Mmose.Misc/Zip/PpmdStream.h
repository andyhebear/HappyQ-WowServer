...
namespace Demo
{
	namespace Mmose
	{
		namespace Zip
		{
			...
			public ref class PpmdStream : public System::IO::Stream
			{
		...
		public:
				PpmdStream(System::IO::Stream^ streamData,  System::IO::Compression::CompressionMode compressionMode );
				PpmdStream(System::IO::Stream^ streamData,  System::IO::Compression::CompressionMode compressionMode, System::Boolean leaveOpen );
				~PpmdStream(void);
				!PpmdStream(void);
				#pragma endregion
