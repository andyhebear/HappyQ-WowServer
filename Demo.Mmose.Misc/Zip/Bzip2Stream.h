...
namespace Demo
{
	namespace Mmose
	{
		namespace Zip
		{
			...
			public ref class Bzip2Stream : public System::IO::Stream
			{
			...
			public:
				Bzip2Stream(System::IO::Stream^ streamData,  System::IO::Compression::CompressionMode compressionMode );
				Bzip2Stream(System::IO::Stream^ streamData,  System::IO::Compression::CompressionMode compressionMode, System::Boolean leaveOpen );
				~Bzip2Stream(void);
				!Bzip2Stream(void);
				#pragma endregion
