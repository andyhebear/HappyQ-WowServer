...
namespace Demo
{
	namespace Mmose
	{
		namespace Zip
		{
			...
			public ref class GZipStream : public System::IO::Stream
			{
			...
			public:
				GZipStream(System::IO::Stream^ streamData,  System::IO::Compression::CompressionMode compressionMode );
				GZipStream(System::IO::Stream^ streamData,  System::IO::Compression::CompressionMode compressionMode, System::Boolean leaveOpen );
				~GZipStream(void);
				!GZipStream(void);
				#pragma endregion
