...
{
    /// <summary>
    ///这是 MovedToWorldEventArgsTest 的测试类，旨在
    ///包含所有 MovedToWorldEventArgsTest 单元测试
    ///</summary>
    [TestClass()]
    public class MovedToWorldEventArgsTest
    {
        ...
        public void OldMapTest()
        {
            ...
            MovedToWorldEventArgs target = new MovedToWorldEventArgs( oldLocation, oldMap, gameEntity ); // TODO: 初始化为适当的值
            BaseMap actual;
        ...
        /// <summary>
        ///MovedToWorldEventArgs 构造函数 的测试
        ///</summary>
        [TestMethod()]
