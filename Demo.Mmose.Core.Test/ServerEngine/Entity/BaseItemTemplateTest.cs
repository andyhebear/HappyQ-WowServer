...
{
    /// <summary>
    ///这是 BaseItemTemplateTest 的测试类，旨在
    ///包含所有 BaseItemTemplateTest 单元测试
    ///</summary>
    [TestClass()]
    public class BaseItemTemplateTest
    {
        ...
        internal virtual BaseItemTemplate_Accessor CreateBaseItemTemplate_Accessor()
        {
            // TODO: 实例化相应的具体类。
            BaseItemTemplate_Accessor target = null;
            return target;
        }
        ...
        public void DefaultItemInitTest()
        {
            ...
            BaseItemTemplate_Accessor target = new BaseItemTemplate_Accessor( param0 ); // TODO: 初始化为适当的值
