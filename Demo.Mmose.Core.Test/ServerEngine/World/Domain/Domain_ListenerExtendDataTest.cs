...
{
    /// <summary>
    ///这是 Domain_ListenerExtendDataTest 的测试类，旨在
    ///包含所有 Domain_ListenerExtendDataTest 单元测试
    ///</summary>
    [TestClass()]
    public class Domain_ListenerExtendDataTest
    {
        ...
        /// <summary>
        ///Domain_ListenerExtendData 构造函数 的测试
        ///</summary>
        [TestMethod()]
