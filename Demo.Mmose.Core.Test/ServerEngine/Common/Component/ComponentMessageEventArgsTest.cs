...
{
    /// <summary>
    ///这是 ComponentMessageEventArgsTest 的测试类，旨在
    ///包含所有 ComponentMessageEventArgsTest 单元测试
    ///</summary>
    [TestClass()]
    public class ComponentMessageEventArgsTest
    {
        ...
        /// <summary>
        ///ComponentMessageEventArgs 构造函数 的测试
        ///</summary>
        [TestMethod()]
