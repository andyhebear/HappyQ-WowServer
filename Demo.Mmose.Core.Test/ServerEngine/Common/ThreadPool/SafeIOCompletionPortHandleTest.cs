...
{
    /// <summary>
    ///这是 SafeIOCompletionPortHandleTest 的测试类，旨在
    ///包含所有 SafeIOCompletionPortHandleTest 单元测试
    ///</summary>
    [TestClass()]
    public class SafeIOCompletionPortHandleTest
    {
        ...
        /// <summary>
        ///SafeIOCompletionPortHandle 构造函数 的测试
        ///</summary>
        [TestMethod()]
