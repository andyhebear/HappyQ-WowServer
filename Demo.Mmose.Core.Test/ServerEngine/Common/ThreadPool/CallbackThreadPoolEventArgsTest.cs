...
{
    /// <summary>
    ///这是 CallbackThreadPoolEventArgsTest 的测试类，旨在
    ///包含所有 CallbackThreadPoolEventArgsTest 单元测试
    ///</summary>
    [TestClass()]
    public class CallbackThreadPoolEventArgsTest
    {
        ...
        /// <summary>
        ///CallbackThreadPoolEventArgs 构造函数 的测试
        ///</summary>
        [TestMethod()]
