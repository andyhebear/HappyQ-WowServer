...
{
    /// <summary>
    ///这是 SafeQueueTest 的测试类，旨在
    ///包含所有 SafeQueueTest 单元测试
    ///</summary>
    [TestClass()]
    public class SafeQueueTest
    {
        ...
        {
            IEnumerable target = new SafeQueue<ValueT>(); // TODO: 初始化为适当的值
        ...
        /// <summary>
        ///SafeQueue`1 构造函数 的测试
        ///</summary>
        public void SafeQueueConstructorTestHelper<ValueT>()
        {
            SafeQueue<ValueT> target = new SafeQueue<ValueT>();
            Assert.Inconclusive( "TODO: 实现用来验证目标的代码" );
        }

        [TestMethod()]
        public void SafeQueueConstructorTest()
        {
            SafeQueueConstructorTestHelper<GenericParameterHelper>();
        }
    }
}
