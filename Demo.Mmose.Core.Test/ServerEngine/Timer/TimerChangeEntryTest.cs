...
{
    /// <summary>
    ///这是 TimerChangeEntryTest 的测试类，旨在
    ///包含所有 TimerChangeEntryTest 单元测试
    ///</summary>
    [TestClass()]
    public class TimerChangeEntryTest
    {
