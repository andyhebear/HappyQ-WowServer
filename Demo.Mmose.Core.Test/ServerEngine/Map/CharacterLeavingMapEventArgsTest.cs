...
{
    /// <summary>
    ///这是 CharacterLeavingMapEventArgsTest 的测试类，旨在
    ///包含所有 CharacterLeavingMapEventArgsTest 单元测试
    ///</summary>
    [TestClass()]
    public class CharacterLeavingMapEventArgsTest
    {
        ...
        public void IsCancelTest()
        {
            ...
            CharacterLeavingMapEventArgs target = new CharacterLeavingMapEventArgs( character, map ); // TODO: 初始化为适当的值
        ...
        /// <summary>
        ///CharacterLeavingMapEventArgs 构造函数 的测试
        ///</summary>
        [TestMethod()]
